...
export const idols = [
  {
    id: "idols1",
    categoryId: "idols",
    title: "Ganesh idol ( with pillow seating)",
    ...
    imageUrl: {
      default: cdnURL + "assets/images/products/idols/1.png",
      imageList: [
        {
          original: cdnURL + "assets/images/products/idols/1.png",
          thumbnail: cdnURL + "assets/images/products/idols/1.png",
        },
      ],
    },
  },
  {
    ...
    care: "Keep metal dry to prevent tarnishing which can dull or destroy the surface. Avoid using abrasive cleaners that can scratch and dull metal surfaces. Prevent liquid detergents or any chemicals from coming into direct contact with metal as it can damage the finish.",
    imageUrl: {
      default: cdnURL + "assets/images/products/idols/2.png",
      imageList: [
        {
          original: cdnURL + "assets/images/products/idols/2.png",
          thumbnail: cdnURL + "assets/images/products/idols/2.png",
        },
      ],
    },
  },
  {
    id: "idols3",
    categoryId: "idols",
    title: "Ganesh idol ( with Lotus seating)",
    type: collections.silver.id,
    subTitle: "Finest Quality Handcrafted Furniture",
    prodSubTitle:
      "Handcrafted from locally sourced natural wood, this bowl can be used for serving scrumptious meals",
    ...
    care: "Keep metal dry to prevent tarnishing which can dull or destroy the surface. Avoid using abrasive cleaners that can scratch and dull metal surfaces. Prevent liquid detergents or any chemicals from coming into direct contact with metal as it can damage the finish.",
    imageUrl: {
      default: cdnURL + "assets/images/products/idols/3.png",
      imageList: [
        {
          original: cdnURL + "assets/images/products/idols/3.png",
          thumbnail: cdnURL + "assets/images/products/idols/3.png",
        },
      ],
    },
  },
  {
    ...
    care: "Keep metal dry to prevent tarnishing which can dull or destroy the surface. Avoid using abrasive cleaners that can scratch and dull metal surfaces. Prevent liquid detergents or any chemicals from coming into direct contact with metal as it can damage the finish.",
    imageUrl: {
      default: cdnURL + "assets/images/products/idols/4.png",
      imageList: [
        {
          original: cdnURL + "assets/images/products/idols/4.png",
          thumbnail: cdnURL + "assets/images/products/idols/4.png",
        },
      ],
    },
  },
  {
    id: "idols5",
    categoryId: "idols",
    title: "Ganesh idol (sleeping pose)",
    type: collections.silver.id,
    subTitle: "Finest Quality Handcrafted Furniture",
    prodSubTitle:
      "Handcrafted from locally sourced natural wood, this bowl can be used for serving scrumptious meals",
    ...
    care: "Keep metal dry to prevent tarnishing which can dull or destroy the surface. Avoid using abrasive cleaners that can scratch and dull metal surfaces. Prevent liquid detergents or any chemicals from coming into direct contact with metal as it can damage the finish.",
    imageUrl: {
      default: cdnURL + "assets/images/products/idols/5.png",
      imageList: [
        {
          original: cdnURL + "assets/images/products/idols/5.png",
          thumbnail: cdnURL + "assets/images/products/idols/5.png",
        },
      ],
    },
  },
